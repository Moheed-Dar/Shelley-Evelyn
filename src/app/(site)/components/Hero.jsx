    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-start h-full px-4 pt-32 sm:pt-36 md:pt-40 lg:pt-44 pb-32">
        <div className="relative flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-12 mb-8 md:mb-10">
         ...
         <h1
  ref={titleRef}
  className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] font-black tracking-tighter leading-none select-none text-center relative z-10 bg-linear-to-r from-[#ffd5f6] via-purple-400 to-white bg-clip-text text-transparent"
  style={{
