...
export default function AdminLoginPage() {
  return (
    <div className="relative h-screen w-screen flex items-center justify-center bg-[#301143] overflow-hidden">
      {/* Background Grid */}
      <div
        className="absolute inset-0 opacity-[0.03] pointer-events-none"
        style={{
      ...
      {/* Top Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-150 h-75 bg-[#FAAE62]/8 rounded-full blur-[120px] pointer-events-none z-0" />

      {/* Bottom Glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-125 h-62.5 bg-[#FAAE62]/5 rounded-full blur-[100px] pointer-events-none z-0" />
