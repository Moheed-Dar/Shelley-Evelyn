      ...
      <AnimatePresence mode="wait">
        {submitted ? (
          ...
          <form key="form" onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="flex items-center gap-1.5 text-[10px] font-bold text-[#FFF7F0]/25 uppercase tracking-[0.2em] mb-1.5">
                <Mail size={10} /> Email <span className="text-[#FFF7F0]/20">(Optional)</span>
              </label>
              <input
                type="email"
                name="email"
            ...
            <div>
              <label className="flex items-center gap-1.5 text-[10px] font-bold text-[#FFF7F0]/25 uppercase tracking-[0.2em] mb-1.5">
                <Phone size={10} /> Phone Number <span className="text-[#FFF7F0]/20">(Optional)</span>
              </label>
              <input
                type="tel"
                name="phone"
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[11px] leading-relaxed text-[#FFF7F0]/45">
                    ...
                    <Link
                      href="/privacy-policy"
                      className="font-semibold text-[#20B2B8] underline underline-offset-2 hover:text-[#F2673A] transition-colors"
                    >
                      Privacy Policy
                    </Link>
                    .
